...
{ 
	...
	for(int run=0;Chariot[run]!='\0';run++)
	{
 	...
 	input_compressed.open("C://Users//youss//Desktop//UNIVERSITY SHIT//YEAR 2//SEMESTER 1//CS213 - Data Structure//Huffman Project//Text Compression File//Compressed.txt");
	if (input_compressed.is_open())
	{
		...
		Decompressed_text.open("C://Users//youss//Desktop//UNIVERSITY SHIT//YEAR 2//SEMESTER 1//CS213 - Data Structure//Huffman Project//Text Compression File//Decompressed.txt", ios::trunc);
...
void Decompress_Image(CList2_Image& TL, int& saved, char*& Chariot,int trav)
{
	...
	input_compressed.open("C://Users//youss//Desktop//UNIVERSITY SHIT//YEAR 2//SEMESTER 1//CS213 - Data Structure//Huffman Project//Image Compression File//Compressed//Test3-Compressed_Output.bmp", ifstream::binary);
	if (input_compressed.is_open())
	{
		/* cout << "Compressed File Detected....." << endl;
		string Encrypted_text;
		...
		Decompressed_text.open("C://Users//youss//Desktop//UNIVERSITY SHIT//YEAR 2//SEMESTER 1//CS213 - Data Structure//Huffman Project//Image Compression File//Decompressed//Test3-Decompressed_Output.bmp", ofstream::binary);
		if (Decompressed_text.is_open())
		{
			cout << "Decompression File Detected...." << endl << endl;
...
void Encrypt_Text(CList2_Text& TL, char input[], int& saved)
{
    ...
    char ask_decrypt='d';
	compressed.open("C://Users//youss//Desktop//UNIVERSITY SHIT//YEAR 2//SEMESTER 1//CS213 - Data Structure//Huffman Project//Text Compression File//Compressed.txt", ios::trunc);
...
void Compress_Image(CList2_Image& TL, char*& img_data, int& saved, int byte_ct)
{
	...
	char ask_decrypt = 'd';
	char ask_ASCII;
	compressed.open("C://Users//youss//Desktop//UNIVERSITY SHIT//YEAR 2//SEMESTER 1//CS213 - Data Structure//Huffman Project//Image Compression File//Compressed//Test3-Compressed_Output.bmp", ofstream::binary);
	if (compressed.is_open())
	{
		cout << "Compression File Detected....." << endl << endl;
...
int main()
{
	...
	if(Ask_TorI=='t')
	{
		...
		Input_text.open("C://Users//youss//Desktop//UNIVERSITY SHIT//YEAR 2//SEMESTER 1//CS213 - Data Structure//Huffman Project//Text Compression File//Input.txt");
	...
	char ask_encode_img;
		...
		int flag = 0, ctfreq = 1, i;
		int save_curr = 0;
		ifstream Input_File("C://Users//youss//Desktop//UNIVERSITY SHIT//YEAR 2//SEMESTER 1//CS213 - Data Structure//Huffman Project//Image Compression File//Input//Test3-Input.bmp", ifstream::binary);
